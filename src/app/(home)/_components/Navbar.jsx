        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center gap-3">
              <div className="hidden md:flex h-10 w-10 rounded-md bg-emerald-600 items-center justify-center text-white font-bold">
                M
              </div>
              <button
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg font-semibold">MedsOnline4u</h1>
            ...
            <Link href={"/"}><h2 className="font-bold md:hidden text-2xl">MedsOnline4u</h2></Link>
